...
public class Main {
	...
	public static void main(String[] args) {
		...
		List<Fruit> fruitResult = find(fruits, fruit -> fruit.getName()
				.equals("Apple"));
